...
<body>
    <header>
        <nav >
            <div class="row">
                <img src="resources/img/logo-white.png" alt="Onnifood logo" class="logo">
                <img src="resources/img/logo.png" alt="Onnifood logo" class="logo-black">
                <!-- 
                <ul class="main-nav js--main-nav">
                    <li><a href="#">Food delivery </a></li>
                    <li><a class="js--scroll-to-works" href="#">How it works </a></li>
                    <li><a href="#">Our cities </a></li>
                    <li><a href="#">Sign up </a></li>
                </ul>   
                    -->
                <ul class="main-nav js--main-nav">
                    <li><a class="js--scroll-to-features" href="#">Food delivery </a></li>
                    <li><a class="js--scroll-to-works" href="#">How it works </a></li>
                    <li><a class="js--scroll-to-cities" href="#">Our cities </a></li>
                    <li><a class="js--scroll-to-sign-up" href="#">Sign up </a></li>
                </ul>
        ...
        <div class="hero-text-box">
            ...
            <a class="btn btn-ghost js--scroll-to-start" href="#"> how me more</a>
        </div>
    </header>
    ...
    <section class="section-cities js--section-cities" id="cities">
        ...
        <div class="row js--wp-3">
            <div class="col span-1-of-4 box">
                ...
                <div class="city-feature" id="cities">
            ...
            <div class="col span-1-of-4 box">
                <img src="resources/img/san-francisco.jpg" alt="San Fransico">
                <div class="city-feature">
                    <h3>San Fransico</h3>
                    <i class="ion-ios-person icon-small"></i>
                    3700+ happy eaters
        ...
        <div class="row">
            <div class="col span-1-of-3">
                ...
                omnifood is just awesome! I just launched a startup which leaves me with no time for cooking, so Omnifood is a life-saver. Now that I got used to it, I couldn't live without my daily meals!
                    <cite><img src="resources/img/custome.jpg" alt="Customer 1 Photo">Alberto Duncan</cite>
                </blockquote>
            </div>
    ...
    <section class="section-form js--section-sign-up">
    <div class="map-box"> 
